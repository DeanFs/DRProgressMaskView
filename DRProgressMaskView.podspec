...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of DRProgressMaskView.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Dean_F/DRProgressMaskView'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Dean_F' => 'stone.feng1990@gmail.com' }
  s.source           = { :git => 'https://github.com/Dean_F/DRProgressMaskView.git', :tag => s.version.to_s }
